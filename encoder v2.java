...
public class Encoder extends LinearOpMode {
    ...
    int flTarget = (int)(30 * DRIVE_COUNTS_PER_IN); 
    int frTarget = (int)(30 * DRIVE_COUNTS_PER_IN); 
    int blTarget = (int)(30 * DRIVE_COUNTS_PER_IN); 
    int brTarget = (int)(30 * DRIVE_COUNTS_PER_IN); 
